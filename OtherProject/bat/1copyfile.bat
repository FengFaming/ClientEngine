xcopy C:\Users\admin\Documents\GitHub\ClientEngine\OtherProject\GameFileServer\GameFileServer\bin\Debug\*.* C:\Users\admin\Documents\GitHub\ClientEngine\OtherProject\bat /s /e /c /y /h /r
