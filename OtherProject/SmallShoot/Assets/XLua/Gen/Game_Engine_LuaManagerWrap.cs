...
namespace XLua.CSObjectWrap
{
    ...
    public class GameEngineLuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SendMessageToThread", _m_SendMessageToThread);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SendMessageToThread(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SendMessageToThread( _key, _arms );
